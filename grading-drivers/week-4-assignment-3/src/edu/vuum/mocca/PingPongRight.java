...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
    	...
    	private final static String[] semaphoreNotes 
         ...
         */
        // TODO - You fill in here.
		private final SimpleSemaphore[] semaphores;
        /**
        ...
        public PlayPingPongThread(String stringToPrint,
                                  ...
                                  int maxIterations) {
            // TODO - You fill in here.
        	semaphores = new SimpleSemaphore[] { semaphoreOne,semaphoreTwo};
        	this.maxIter = maxIterations;
        	this.toPrint = stringToPrint;
        }
